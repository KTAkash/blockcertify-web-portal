  ...
  return (
    <div className="rounded-[20px] border border-[#E4DEF2] bg-[#FAF9FC] p-6 shadow-[0_10px_30px_rgba(29,19,48,0.04)]">
      <div className="mb-8 flex items-start justify-between">
        <div className="text-[13px] font-semibold uppercase tracking-[0.16em] text-[#7A7290] font-[family-name:var(--font-display)]">
          {label}
        </div>
        <div className="rounded-xl bg-[#E4DEF2] p-2 text-[#7C3AED]">{icon}</div>
      </div>
      <div className="text-[30px] font-bold tracking-tight text-[#1D1330] font-[family-name:var(--font-display)]">{value}</div>
    </div>
  );
}
...
function StatusPill({ status }: { status: CertificateRow['status'] }) {
  ...
  return (
    <span className={`inline-flex rounded-full px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] ${classes} font-[family-name:var(--font-display)]`}>
      {status}
    </span>
  );
}
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="rounded-[20px] border border-[#E4DEF2] bg-[#FAF9FC] p-6 shadow-[0_10px_30px_rgba(29,19,48,0.04)]">
          <div className="mb-6 flex items-center gap-3">
            ...
            <h3 className="text-lg font-bold tracking-tight text-[#1D1330] font-[family-name:var(--font-display)]">Credential Keys</h3>
          </div>

          <div className="rounded-2xl bg-[#E4DEF2] px-4 py-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <div className="text-[12px] font-semibold uppercase tracking-[0.14em] text-[#7A7290] font-[family-name:var(--font-display)]">
              ...
              <span className="rounded-full bg-emerald-50 px-3 py-1 text-sm font-bold uppercase tracking-[0.12em] text-emerald-600 font-[family-name:var(--font-display)]">
                Active
              </span>
            </div>
          </div>

          <button className="mt-6 w-full rounded-[10px] bg-[#5B21B6] px-5 py-4 text-sm font-bold text-white shadow-[0_14px_30px_rgba(91,33,182,0.18)] transition-colors hover:bg-[#4C1D95] font-[family-name:var(--font-display)]">
            Rotate Authority Keys
          </button>
        </div>

        <div id="nodes" className="rounded-[20px] border border-[#E4DEF2] bg-[#FAF9FC] p-6 shadow-[0_10px_30px_rgba(29,19,48,0.04)]">
          <div className="mb-6 flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#E4DEF2] text-[#7C3AED]">
              <EndpointIcon />
            </span>
            <h3 className="text-lg font-bold tracking-tight text-[#1D1330] font-[family-name:var(--font-display)]">Node Connectivity</h3>
          </div>

          <div className="space-y-6">
            <div className="flex items-center justify-between gap-4 border-b border-[#E4DEF2] pb-4">
              <span className="text-xs font-semibold uppercase tracking-[0.14em] text-[#7A7290] font-[family-name:var(--font-display)]">Endpoint</span>
              <span className="text-sm font-medium text-[#1D1330] font-[family-name:var(--font-display)]">peer0.tech-uni.fabric.net</span>
            </div>
            <div className="flex items-center justify-between gap-4 border-b border-[#E4DEF2] pb-4">
              <span className="text-xs font-semibold uppercase tracking-[0.14em] text-[#7A7290] font-[family-name:var(--font-display)]">Status</span>
              <span className="text-sm font-bold uppercase tracking-[0.12em] text-emerald-600 font-[family-name:var(--font-display)]">Consensus Reached</span>
            </div>

            <div>
              <div className="mb-2 flex items-center justify-between text-xs font-semibold uppercase tracking-[0.14em] text-[#7A7290] font-[family-name:var(--font-display)]">
            ...
            <tbody>
              {certificates.map((certificate) => (
                <tr key={certificate.id} className="border-b border-[#E4DEF2] last:border-b-0">
                  ...
                  <td className="px-6 py-5 text-sm text-[#1D1330] font-[family-name:var(--font-display)]">{certificate.credential}</td>
                  <td className="px-6 py-5 text-sm text-[#1D1330] font-[family-name:var(--font-display)]">{certificate.issueDate}</td>
                  <td className="px-6 py-5">
